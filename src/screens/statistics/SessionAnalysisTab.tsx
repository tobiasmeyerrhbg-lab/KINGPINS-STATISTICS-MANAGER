...
const styles = StyleSheet.create({
  ...
  content: { padding: 12 },
  title: { fontSize: 22, fontWeight: '700', color: '#000000', marginBottom: 16 },
  card: { backgroundColor: '#ffffff', borderRadius: 8, padding: 12, marginBottom: 12, shadowColor: '#000', shadowOpacity: 0.05, elevation: 2 },
  sectionTitle: { fontSize: 14, fontWeight: '700', color: '#000000', marginBottom: 8 },
  ...
  dropdownText: { fontSize: 14, color: '#000000', fontWeight: '600' },
  ...
  modeButtonText: { fontSize: 12, fontWeight: '600', color: '#000000', textAlign: 'center' },
  ...
  toggleText: { fontSize: 14, color: '#000000', fontWeight: '600' },
  ...
  presetInputPlaceholder: { fontSize: 14, color: '#000000' },
  ...
  loadButtonText: { fontSize: 16, fontWeight: '700', color: '#000000' },
  ...
  presetListTitle: { fontSize: 14, fontWeight: '700', color: '#000000', marginBottom: 8 },
  presetItem: { flexDirection: 'row', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#e2e8f0', alignItems: 'center' },
  presetItemName: { fontSize: 14, fontWeight: '600', color: '#000000' },
  presetItemMeta: { fontSize: 12, color: '#000000', marginTop: 4 },
  ...
  sessionItemText: { fontSize: 14, fontWeight: '600', color: '#000000' },
  sessionItemMeta: { fontSize: 12, color: '#000000', marginTop: 4 },
  ...
  penaltyItemText: { fontSize: 14, fontWeight: '600', color: '#000000' },
  penaltyItemMeta: { fontSize: 12, color: '#000000', marginTop: 4 },
});
